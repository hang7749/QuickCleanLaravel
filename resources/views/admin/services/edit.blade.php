...
<div style="max-width: 700px; margin: 0 auto;">
    <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 25px;">
        <h2 style="font-weight: 800;">Edit Service: {{ $service->name }}</h2>
    </div>
    ...
    <div style="background: #fff; padding: 30px; border-radius: 16px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
        <form action="{{ route('admin.services.update', $service->id) }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                <div>
                    <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #1e293b;">Service Name</label>
                    <input type="text" name="name" value="{{ $service->name }}" required 
                           style="width: 100%; padding: 12px; border: 1px solid #cbd5e1; border-radius: 8px;">
                </div>
                <div>
                    <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #1e293b;">Price (RM)</label>
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #1e293b;">Image URL</label>
                ...
                <div style="margin-top: 15px; padding: 10px; background: #f8fafc; border-radius: 8px; display: flex; align-items: center; gap: 15px;">
                    ...
                    <span style="font-size: 12px; color: #64748b;">Current Image Preview</span>
                </div>
                @endif
            </div>

            <div style="margin-bottom: 25px;">
                <label style="display: block; font-weight: 600; margin-bottom: 8px; color: #1e293b;">Description</label>
            ...
            <div style="display: flex; gap: 12px; border-top: 1px solid #f1f5f9; pt: 25px; margin-top: 20px; padding-top: 20px;">
                ...
                <a href="{{ route('admin.services.index') }}" style="padding: 12px 30px; text-decoration: none; color: #64748b; font-weight: 600;">Cancel</a>
            </div>
        </form>
    </div>
</div>
